...
//                System.out.println("rowCount:" + rowCount);
    ...
    public boolean updateErpComprobantes(ErpFeComprobantes disp, String fecha) {
        ...
        try {
            ...
            String hql = "update ErpFeComprobantes set CONCEPTO_CXP = '" + disp.getConceptoCxp() + "', CTO_CXP = '" + disp.getCtoCxp() + "', FECHA_VENC_CXP = :fecha  where id.compania = :compania and id.numero = :numero";
            Query query = session.createQuery(hql);
...
//                System.out.println("rowCount:" + rowCount);
    ...
    public boolean actualizaEstatusFolioPagos(ErpFeComprobantes comp, String monedaPago) {
        ...
        try {
            ...
            String hql = "update ErpFeComprobantes set tipoPago =:tipoPago, totalAPagar =:totalAPagar, monedaPago =:monedaPago, estatusCxp = :estatusCxp, folioPagos = :folioPagos where  id.compania = :compania and id.numero = :numero";
...
//                System.out.println("rowCount:" + rowCount);
    ...
    public boolean actualizaEstatusFolioPagosCie(ErpFeComprobantes comp, String monedaPago,int pagoCie) {
        Session session = sessionFactory.openSession();
        Transaction transaccion = session.beginTransaction();
        ...
        try {
            ...
            String hql = "update ErpFeComprobantes set conceptoCie =:conceptoCie, referenciaCie =:referenciaCie, pagoCie =:pagoCie, monedaPago =:monedaPago, estatusCxp = :estatusCxp, folioPagos = :folioPagos where  id.compania = :compania and id.numero = :numero";
            ...
            query.setInteger("numero", comp.getId().getNumero());
            query.setString("monedaPago", monedaPago);
            query.setInteger("pagoCie", pagoCie);
...
//                System.out.println("rowCount:" + rowCount);
        ...
        try {
            ...
            String hql = "update ErpFeComprobantes set DESCRIPCION_CANCELACION = '" + descripcionCan + "' where  id.compania = :compania and id.numero = :numero";
