Ext.define('AppPortalAereo.view.FormCXPOtros', {
    ...
    height: 480,
    width: 400,
    url: 'CXP/saveOtrosCXPPortalAereo',
    initComponent: function() {
        ...
        var storeDivisa = Ext.create('AppPortalAereo.store.StoreDivisa');
