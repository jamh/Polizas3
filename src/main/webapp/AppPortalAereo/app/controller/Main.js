Ext.define('AppPortalAereo.controller.Main', {
    ...
    refs: [
        ...
        },
        {
        ...
        },
         {
            ...
            ref: 'formIngresaPortal',
            selector: 'formingresaportal'
    ...
    init: function () {
        ...
        this.control({
            ...
            formingresaportal:{
                ...
                ingresaPermisosPortal:function(btn){
                    
                      me.ingresaPermisosPortal(btn);
                }
...
//            },
            callback: function(records, operation, success) {
                ...
                var redirect = '/Polizas3/PortalAereo';
    ...
    saveArchivo: function(btn) {
        ...
        var me = this,
            ...
            if (basicForm.isValid()) {
                ...
                basicForm.submit({
                     url:'Uploadprov/savePortalAereo',
...
//            record.data.MONEDA = 'N/A';
    ...
    ingresaPortal:function(){
      
        var window=  Ext.create('Ext.window.Window', {
                                       // title: titleIngreso.translations,
                                        height: 160,
                                        width: 300,
                                        closable : false, 
                                         modal: true,
    ...
    ingresaPermisosPortal:function(btn){
        ...
        form = btn.up('formingresaportal'),
        winForm = form.up('window'),

         basicForm = form.getForm();

        var ingreso = basicForm.findField('cboIngresaPortal').getValue();

        me.permisosTipoProv(ingreso,winForm);
    },
    
    permisosTipoProv:function(tipoCuenta,winForm){
