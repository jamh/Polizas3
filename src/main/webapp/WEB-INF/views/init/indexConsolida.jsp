<%-- 
    Document   : index
    Created on : 18/06/2015, 12:47:57 PM
    Author     : ING. JAMH
--%>
...
<html>
    ...
    <title id="page-title">Consolida Saldos</title>
    ...
    <link rel="stylesheet" type="text/css" href="resources/js/ux/grid/css/RangeMenu.css"/>
     <link rel="stylesheet" type="text/css" href="resources/js/dropzone/css/dropzone.css"/>
    ...
    <script type="text/javascript" src="resources/js/monitor/Ext.ux.ActivityMonitor.js"></script>
       <script type="text/javascript" src="resources/js/dropzone/dropzone.js"></script>
    ...
    <script type="text/javascript" src="AppConsolida/app.js"></script>
</head>
<body>
</body>
</html>