...
<html>
    ...
    <title id="page-title">Proveedores</title>
    ...
    <link rel="stylesheet" type="text/css" href="resources/js/ux/grid/css/RangeMenu.css"/>
       ...
       <link rel="stylesheet" type="text/css" href="http://www.appferaz1.com/extjs/extjs4.2/packages/ext-theme-classic/build/resources/ext-theme-classic-all.css" />
    ...
    <script type="text/javascript" src="AppProveedores/app.js"></script>
</head>
<body>
</body>
</html>