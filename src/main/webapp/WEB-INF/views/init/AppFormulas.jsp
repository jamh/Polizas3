...
<html>
    ...
    <title id="page-title">Formula</title>
  ...
  -->
   <link rel="stylesheet" type="text/css" href="http://www.appferaz1.com/extjs/extjs5.1/build/packages/ext-theme-neptune/build/resources/ext-theme-neptune-all.css" />
  ...
  <!-- <script type="text/javascript" charset="utf-8" src="http://www.appferaz1.com/extjs/extjs4.2/locale/ext-lang-es.js"></script>
    ...
    <script type="text/javascript" src="AppFormulas/app.js"></script>
</head>
<body>
</body>
</html>