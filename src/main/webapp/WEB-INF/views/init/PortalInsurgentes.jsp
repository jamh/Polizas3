<%-- 
    Document   : Portal de carga de facturas
...
<html>
    ...
    <title id="page-title">Portal Facturas</title>
    ...
    <link rel="stylesheet" type="text/css" href="resources/js/ux/grid/css/RangeMenu.css"/>
      ...
      <link rel="stylesheet" type="text/css" href="resources/css/formater.css"/>
       <link rel="stylesheet" type="text/css" href="http://www.appferaz1.com/extjs/extjs5.1/build/packages/ext-theme-neptune/build/resources/ext-theme-neptune-all-debug.css" />
    ...
    <script type="text/javascript" src="resources/translations/es.js"></script>
    <script type="text/javascript" src="resources/locale/ext-lang-es.js"></script>
    <script type="text/javascript" src="AppPortalInsurgentes/app/app.js"></script>
</head>
<body>
</body>
</html>