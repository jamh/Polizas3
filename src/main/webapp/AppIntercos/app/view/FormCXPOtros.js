Ext.define('AppIntercos.view.FormCXPOtros', {
    ...
    initComponent: function() {
        ...
        var storeTipoGasto = Ext.create('AppIntercos.store.StoreTipoGasto');
        var storeDivisa = Ext.create('AppIntercos.store.StoreDivisa');
        var storeEmpleados = Ext.create('AppIntercos.store.StoreEmpleados');
