Ext.define('AppIntercos.controller.Main', {
                        ...
                        if (tipo === 'GRID'){
                          if (!Ext.isEmpty(hidden)){ 
                              if (hidden === '1'){
                                ...
                                if(componente === 'gridviaticos'){
                                  tab.items.items[2].tab.hide();//.tab.hide();
                                }
                                
                                if(componente === 'cargaXml'){
    ...
    guardaConceptos: function(btn){
        ...
        if (basicForm.isValid()) {
            ...
            if (!record) {
                ...
                record = Ext.create('AppIntercos.model.ModelGridConceptosCxp');
                record.set(values);
               ...
               if (r.data.TIPO_PAGO_TES === 'PAR'){
                ...
                if (r.data.CIE === '1'){
                   ...
                   if (Ext.isEmpty(r.data.CONCEPTO_CIE)){
                    ...
                    if (r.data.CTA_CLABE_PROV === 'N/A' || Ext.isEmpty(r.data.CTA_CLABE_PROV)){
     ...
     guardaRembolso: function(){
        ...
        enviaCorreoCancelacion: function(data){
            ...
            for (var i=0; i < data.length; i++) {
                        ...
                        Ext.Ajax.request({
                        url: 'http://appferaz1.com/CorreosAvisos/cancelacionFact.jsp',
    ...
    findArchivos2:function(factura,calendario,periodo,periodoFin) {
        ...
        var ver = Ext.getCmp('cboverCXP').getValue();
         ...
         if (Ext.isEmpty(ver)){
            ...
            dirBus = 'process/data3/BuscaArchivosCXPIntercos';
...
//                     var importeDoc = selection[i].data.IMPORTE_DOC;
                   ...
                   if(tipoComprobante === 'egreso' && saldoCxpNota !== 0){
                   ...
                   if(tipoComprobante === 'ingreso' && saldoCxpFact > 0){
