Ext.define('AppCargaFE2.view.FormSatCXC', {
    extend: 'Ext.form.Panel',
    alias: 'widget.formsatcxc',
    itemId: 'formsatcxc',
    xtype: 'formsatcxc',
  //  title:'CXC',
    //flex:1,
            ...
            items: [
                        ...
                        
               {
                ...
                },
                 {
                  ...
                  {
                    xtype: 'combobox',
                    id: 'cboCxpCalendariocxc',
                    fieldLabel: 'Calendario',
                    name: 'calendario',
                    itemId: 'cboCxpCalendariocxc',
                     ...
                     listeners: {
                        ...
                        'select': function(valor) {
                            if (Ext.isEmpty(valor.value))
                                return;
                            Ext.getCmp('cboCxpPeriodocxc').clearValue();
                            Ext.getCmp('cboCxpPeriodocxc').setReadOnly(false);
