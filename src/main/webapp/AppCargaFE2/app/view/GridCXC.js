Ext.define('AppCargaFE2.view.GridCXC', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridcxc',
    itemId: 'gridcxc',
    xtype: 'gridcxc',
    store: 'StoreCXC',
    poscol: null,   
...
//            ]
           // },
                        ...
                        'select': function(valor) {
                           ...
                           // Ext.getCmp('cboPeriodoFe').setReadOnly(false);
                            ...
                            storePeriodo.load({
                             ...
                             Ext.getCmp('cboPeriodoFeFin').clearValue();
                           // Ext.getCmp('cboPeriodoFe').setReadOnly(false);
                    ...
                    readOnly:false,
                     listeners: {
                        ...
                        'select': function(valor) {
                         ...
                         me.fireEvent("buscaPorFecha",  Ext.getCmp('cboCalendarioFe').getValue(),Ext.getCmp('cboPeriodoFe').getValue(),Ext.getCmp('cboPeriodoFeFin').getValue());
                ...
                },
                 {
                    ...
                    name: 'cboPeriodoFeFin',
                    itemId: 'cboPeriodoFeFin',
                    displayField: 'PERIODO',
                    valueField: 'PERIODO',              
                    typeAhead: true,
                    minChars: 0,
                     ...
                     listeners: {
                        ...
                        'select': function(valor) {
                          ...
                          beforequery: function(queryEvent, eOpts) {
                               ...
                               storePeriodoFin.proxy.extraParams.calendario = Ext.getCmp('cboCalendarioFe').getValue();
...
//                                iconCls: 'save-icon',
//                                text: 'Poliza Pagos',
//                                itemId: 'btnGuardarArchivosPagos',
//                                id: 'btnGuardarArchivosPagos',
//                                name: 'btnGuardarArchivosPagos',
//                                scope: this,
//                                handler: function(btn) {
//                                    this.fireEvent("guardarArchivosPagos", btn);
//                                }
//
//                            }
