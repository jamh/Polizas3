Ext.define('AppCXPFacturas.view.GridRelFactInt', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridrelfactint',
    itemId: 'gridrelfactint',
    xtype: 'gridrelfactint',
    store: 'StoreRelFactInt',
    autoScroll: true,
    ...
    initComponent: function() {
        ...
        var saldos = Ext.create('Ext.toolbar.TextItem', {id: 'idSaldoInt', text: ''});
...
//                },
                 '->',
                 {
                            ...
                            handler: function(btn) {
                                // msgOut('Excel');
                                me.fireEvent("cleanFiltersCXPInt", btn);
                            }
                  },
                ...
                '-',
                {
                    ...
                    itemId: 'btnGuardarRelacionCxpInt',
                    id: 'btnGuardarRelacionCxpInt',
                    name: 'btnGuardarRelacionCxpInt',
                    scope: this,
                    handler: function(btn) {
                        this.fireEvent("guardarCXPRelacionInt", btn);
                    }
                ...
                },
                {
                    ...
                    itemId: 'btnQuitarRelacionCxpInt',
                    id: 'btnQuitarRelacionCxpInt',
                    name: 'btnQuitarRelacionCxpInt',
                    scope: this,
                    handler: function(btn) {
                        this.fireEvent("borraCXPRelacionInt", btn);
                    }
            ...
            columns: [
...

                {
                    ...
                    name: 'NOMBRE_EMISOR_FACT',
                     filterable: true,
                    hidden: false,
                    id: 'cxpRelNOMBRE_EMISOR_FACTInt',
                    sortable: true,
