Ext.define('AppCXPFacturas.view.FormRelacionPol', {
    ...
    initComponent: function() {
            ...
            var storeTipoPoliza = Ext.create('AppCXPFacturas.store.StoreTipoPoliza');
            ...
            var storeNumeroPol = Ext.create('AppCXPFacturas.store.StoreNumeroPol');
