Ext.define('AppCuentas.view.GridCuentas', {
    ...
    initComponent: function() {
        ...
        var filters = {
          ...
          var storeCuentaSat2 = Ext.create('AppCuentas.store.StoreCtaSat');
        var storeMonedaSat2 = Ext.create('AppCuentas.store.StoreMonedaSat');
        var storeBancosSat2 = Ext.create('AppCuentas.store.StoreBancosSat');
         var storeCuentaComple =Ext.create('AppCuentas.store.StoreCtaComplementaria');
         var storeCuentaPadre = Ext.create('AppCuentas.store.StoreCtaPadre2');
                ...
                },
                {
                ...
                },
                 {
                    ...
                    renderer: function(value) {
                       ...
                       msgOut('storeCuentaComple'+storeCuentaComple);
                     var index = storeCuentaComple.find('CUENTA', value);
                     msgOut('index'+index);
                        if (index > -1) {
                            msgOut('cta');
                            var record = storeCuentaComple.getAt(index);
                ...
                },
                 {
                    ...
                    renderer: function(value) {
                       ...
                       msgOut('storeMonedaSat'+storeMonedaSat2);
                     var index = storeMonedaSat2.find('CODIGO', value);
                     msgOut('index'+index);
                        if (index > -1) {
                            msgOut('divisa');
                            var record = storeMonedaSat2.getAt(index);
                            return record.get('NOMBRE');
                        }else{
                            return value;
...
//                      
//                      
//                     var index2 = storeBancosSat2.find('CLAVE', value);
//                     msgOut('index'+index2);
//                        if (index2 > -1) {
//                           
//                            var record = storeBancosSat2.getAt(index2);
...
//                },
                 {
                    ...
                    renderer: function(value) {
                     ...
                     var index3 = storeCuentaSat2.find('CODIGO_AGRUPADOR', value);
                     msgOut('index'+index3);
                        if (index3 > -1) {
                           
                            var record = storeCuentaSat2.getAt(index3);
                            return record.get('NOMBRE1');
                        }else{
                            return value;
