Ext.define('AppCuentas.view.FormCuentas', {
    ...
    initComponent: function() {
        ...
        var storeCuentaPadre = Ext.create('AppCuentas.store.StoreCuentaPadre');
        var storeCuentaSat = Ext.create('AppCuentas.store.StoreCtaSat');
        var storeMonedaSat = Ext.create('AppCuentas.store.StoreMonedaSat');
        var storeBancosSat = Ext.create('AppCuentas.store.StoreBancosSat');
